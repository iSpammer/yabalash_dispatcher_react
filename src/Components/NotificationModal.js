    ...
    return (
      <View style={{overflow: 'hidden', borderRadius: moderateScale(10)}}>
        ...
        <View style={{padding: 8}}>
         ...
         { getBundleId()==appIds.dot && <View style={{flexDirection:'row',justifyContent:"space-between"}}>
                {!!customerData?.name ? (
                  <View style={styles.taskacceptrRejectContainer}>
                    <Text numberOfLines={1} style={{...styles.taskIdTextStyle,textTransform:'capitalize'}}>
